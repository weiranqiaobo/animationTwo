    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe startKeyFrame1=Keyframe.ofFloat(0.5f,100);
                Keyframe startKeyFrame2=Keyframe.ofFloat(1f,80);
                PropertyValuesHolder progress = PropertyValuesHolder.ofKeyframe("progress", startKeyframe, startKeyFrame1, startKeyFrame2);
